          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="e.g. TCS"
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="tanId" value={formData.tanId} onChange={handleChange} placeholder="DELT12345G"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" name="gstId" value={formData.gstId} onChange={handleChange} placeholder="21AAAAA1111A2Z1"
                    className="w-full pl-11 pr-4 py-3.5 bg-white border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-[#EA580C] focus:ring-2 focus:ring-[#EA580C]/10 transition-all text-gray-900 font-medium uppercase" />
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleOtpVerify} className="space-y-6">
            <div>
              ...
              <input type="text" value={otp} 
                ...
                placeholder="870651" maxLength={6}
