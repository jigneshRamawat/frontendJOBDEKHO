...
const PopularSearch = () => {
  ...
  const handleNavigate = (selectedFilter) => {
    navigate(`/jobs?type=${selectedFilter}`);
  };
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[350px_1fr] gap-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {jobs.map((job, index) => (
            <div
              key={index}
              onClick={() => handleNavigate(job.filter)}
            ...
            >
              ...
              <button className="absolute bottom-8 left-8 text-[#EA590D] font-semibold">
                View all →
              </button>
